...
Wawro and Katznelson argue that the standard applications of statistical modeling to the study of historical political institutions -- and history more generally -- do not fully address certain key features common to the most successful historical analyses. This thesis represents both a new empirical demonstration of their critiques and recommendations. Considerable space is given to a formal description of the proposed statistical models and the computational tasks and challenges involved.
\end{changemargin}
\end{quote}
\end{abstract}
