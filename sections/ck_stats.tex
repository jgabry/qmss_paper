...
Instead of Cox and Katz's ``sort of running average" approach, the hierarchical Bayesian STAR model entails estimating the unknown functions $f_\lambda$ and $f_\rho$. As discussed in section~\ref{star}, the vectors of evaluations of the unknown functions can be conveniently expressed as the products 
...
\noindent where $\kappa \leq C$ is a positive integer and $\mathbf{G}$ is the undirected graph with nodes $V = \{v_1, \dots, v_C\}$ and the edges implied by $\partial^\mathbf{G}$ (see Figure~\ref{fig:undirected_graphs}). 
...
\node[obs, right=of name,  fill=LightYellow] (r1) {$C_{1}$};
\node[obs, right=of r1, fill=LightYellow] (r2) {$C_{2}$};
\node[obs, right=of r2, fill=LightYellow] (r3) {$C_{3}$};
\node[obs, right=of r3, fill=LightYellow] (r4) {$C_{4}$};
\node[obs, right=of r4, fill=LightYellow] (r5) {$C_{5}$};
\node[obs, right=of r5, fill=LightYellow] (r6) {$C_{6}$};
...
\node[obs, right=of name,  fill=Azure] (r1) {$C_{1}$};
\node[obs, right=of r1, fill=Azure] (r2) {$C_{2}$};
\node[obs, right=of r2, fill=Azure] (r3) {$C_{3}$};
\node[obs, right=of r3, fill=Azure] (r4) {$C_{4}$};
\node[obs, right=of r4, fill=Azure] (r5) {$C_{5}$};
\node[obs, right=of r5, fill=Azure] (r6) {$C_{6}$};
\node[const, right=of r6] (dots1) {$\hspace{.33cm}$};
\node[const, right=of dots1] (dots2) {$\hspace{.33cm}$};
\node[const, right=of dots2] (dots3) {$$};
...
\node[obs, right=of name,  fill=Honeydew] (r1) {$C_{1}$};
\node[obs, right=of r1, fill=Honeydew] (r2) {$C_{2}$};
\node[obs, right=of r2, fill=Honeydew] (r3) {$C_{3}$};
\node[obs, right=of r3, fill=Honeydew] (r4) {$C_{4}$};
\node[obs, right=of r4, fill=Honeydew] (r5) {$C_{5}$};
\node[obs, right=of r5, fill=Honeydew] (r6) {$C_{6}$};
\node[const, right=of r6] (dots1) {$\hspace{.33cm}$};
\node[const, right=of dots1] (dots2) {$\hspace{.33cm}$};
\node[const, right=of dots2] (dots3) {$$};
\edge [-, color=MidnightBlue, bend left = 5] {r1} {r2} ;
