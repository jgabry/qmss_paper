...
$\phi = \alpha + \beta$. This parameterization allows for modeling ${\rm logit}(\theta)$ by the semi-parametric structured additive predictor $\eta$ of the STAR model. 
...
\node[obs, right=of name,  fill=LightYellow] (r1) {$\nu_{1}$};
\node[obs, right=of r1, fill=LightYellow] (r2) {$\nu_{2}$};
\node[obs, right=of r2, fill=LightYellow] (r3) {$\nu_{3}$};
\node[obs, right=of r3, fill=LightYellow] (r4) {$\nu_{4}$};
\node[obs, right=of r4, fill=LightYellow] (r5) {$\nu_{5}$};
\node[obs, right=of r5, fill=LightYellow] (r6) {$\nu_{6}$};
...
\node[obs, right=of name,  fill=Azure] (r1) {$\nu_{1}$};
\node[obs, right=of r1, fill=Azure] (r2) {$\nu_{2}$};
\node[obs, right=of r2, fill=Azure] (r3) {$\nu_{3}$};
\node[obs, right=of r3, fill=Azure] (r4) {$\nu_{4}$};
\node[obs, right=of r4, fill=Azure] (r5) {$\nu_{5}$};
\node[obs, right=of r5, fill=Azure] (r6) {$\nu_{6}$};
\node[const, right=of r6] (dots1) {$\hspace{.33cm}$};
\node[const, right=of dots1] (dots2) {$\hspace{.33cm}$};
\node[const, right=of dots2] (dots3) {$$};
...
\node[obs, right=of name,  fill=Honeydew] (r1) {$\nu_{1}$};
\node[obs, right=of r1, fill=Honeydew] (r2) {$\nu_{2}$};
\node[obs, right=of r2, fill=Honeydew] (r3) {$\nu_{3}$};
\node[obs, right=of r3, fill=Honeydew] (r4) {$\nu_{4}$};
\node[obs, right=of r4, fill=Honeydew] (r5) {$\nu_{5}$};
\node[obs, right=of r5, fill=Honeydew] (r6) {$\nu_{6}$};
\node[const, right=of r6] (dots1) {$\hspace{.33cm}$};
\node[const, right=of dots1] (dots2) {$\hspace{.33cm}$};
\node[const, right=of dots2] (dots3) {$$};
\edge [-, color=MidnightBlue, bend left = 5] {r1} {r2} ;
