...
\node[obs, right=of name,  color=BlueGreen, text=black] (r1) {$\nu_{1}$};
\node[obs, right=of r1,  color=BlueGreen, text=black] (r2) {$\nu_{2}$};
\node[obs, right=of r2,  color=BlueGreen, text=black] (r3) {$\nu_{3}$};
\node[obs, right=of r3,  color=BlueGreen, text=black] (r4) {$\nu_{4}$};
\node[obs, right=of r4,  color=BlueGreen, text=black] (r5) {$\nu_{5}$};
\node[obs, right=of r5,  color=BlueGreen, text=black] (r6) {$\nu_{6}$};
...
\node[obs, right=of name,  color=BlueGreen, fill = LightYellow, text=black] (r1) {$\nu_{1}$};
\node[obs, right=of r1, color=BlueGreen, fill = LightYellow, text=black] (r2) {$\nu_{2}$};
\node[obs, right=of r2, color=BlueGreen, fill = LightYellow, text=black] (r3) {$\nu_{3}$};
\node[obs, right=of r3, color=BlueGreen, fill = LightYellow, text=black] (r4) {$\nu_{4}$};
\node[obs, right=of r4, color=BlueGreen, fill = LightYellow, text=black] (r5) {$\nu_{5}$};
\node[obs, right=of r5, color=BlueGreen, fill = LightYellow, text=black] (r6) {$\nu_{6}$};
\node[const, right=of r6] (dots1) {$\hspace{.33cm}$};
\node[const, right=of dots1] (dots2) {$\hspace{.33cm}$};
\node[const, right=of dots2] (dots3) {$$};
