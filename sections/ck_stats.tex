...
\caption{The undirected graphs corresponding to $\kappa = 1$, $\kappa = 2$ and $\kappa = 3$. Each node represents a Congress. The dashed lines indicate that only part of the graph is shown due to space constraints.}
