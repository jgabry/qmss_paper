...
%\footnote{Stan computes gradients using 
%reverse-mode automatic differentiation. A paper on the details of Stan's especially efficient 
%implementation of automatic differentiation is forthcoming.}  
...
terms of effective sample size \shortcite{betancourt_hamiltonian_2013,stan_development_team_stan_2015}. 
...
checking (Appendix E), %Appendix~\ref{AppendixF})
