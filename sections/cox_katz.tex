...
When inferences are made using posterior simulations generated by a Markov chain Monte Carlo algorithm it is essential to check for evidence that the Markov chains have converged to the target distribution.   
