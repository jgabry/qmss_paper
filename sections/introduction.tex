...
%
%It is argued that inference
%on the basis of a model is not possible unless the model admits a natural
%extension that includes the domain for which inference is required.
