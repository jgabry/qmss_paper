...
%parameters of interest may exhibit considerable variation over time. 

%The challenge of describing the intricacies of historical processes, nor would such a model be 
%useful.
...
discusses one such example.} These concerns are the focus of \citeA{wawro_designing_2014}, 
...
%makes little sense under the a priori
%assumption of parameter homogeneity. If parameter variation is minimal, this should be 
%discovered, not imposed. That is, there is a difference between 
...
\citeA{wawro_designing_2014} presents these ideas in the context of the historical study of political 
